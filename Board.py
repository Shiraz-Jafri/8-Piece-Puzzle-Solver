...
# This class represents the actual Board structure of the game
# matrix - a double sub-scripted list containing the description of the
# current game State with 0 indicating the blank
...
# A function that returns a tuple containing the (row, col) position of the
# given element in the board
...
# A function that puts the four sliding functions together, and takes direction
# as input
